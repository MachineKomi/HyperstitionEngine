...
- For projected graphs, name the measured dimensions, normalization and edge meanings. Keep data-space neighbor relationships independent of camera movement; projected overlap is not evidence of similarity or causation. Provide a non-spatial selector for every node, including overlapping points. The atlas projection regression and rationale are recorded in [docs/ATLAS.md](docs/ATLAS.md).
